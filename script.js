...
console.log(message.style.color); // not get it not inline style.
console.log(message.style.backgroundColor); // it will get it is inline.
...
// logo.setAttribute('designer', 'Divya');
logo.setAttribute('company', 'Bankest');
...
//     console.log(e.currentTarget === this);
//   }
//   // ,true - if true capture propagation
// );
